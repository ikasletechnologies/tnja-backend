...
export declare const getMyEvents: (req: Request, res: Response) => Promise<Response<any, Record<string, any>>>;
...
export declare const getEventSections: (req: Request, res: Response) => Promise<Response<any, Record<string, any>>>;
